...
max_gen=500
#_____________________________________________________________________________________
user=input('\nBy default a 10x10 maze will be solved\nDo you want to enter the maze size, population size and max generation? (y if \'yes\'): ')

if user=='y' or user=='Y':
    row,column=eval(input('Enter the maze size (row,column):  '))
    pop_size=int(input('Enter the population size (multiple of 100): '))
    max_gen=int(input('Enter the maxmimum number of generations: '))
start=(row,column)
goal=(1,1)
# # _____________________________________________________________________________________
